...
\n-- JOIN with date filter\nSELECT c.customer_name, o.order_date\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nWHERE o.order_date >= '2026-01-01';\n\n-- JOIN with order amount range\nSELECT c.customer_name, o.order_amount\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nWHERE o.order_amount BETWEEN 500 AND 2000;\n\n-- JOIN with city grouping\nSELECT c.city, COUNT(o.order_id) AS order_count\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.city;\n\n-- JOIN with total spend by city\nSELECT c.city, SUM(o.order_amount) AS total_spend\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.city;\n\n-- JOIN with average order by city\nSELECT c.city, AVG(o.order_amount) AS average_order\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.city;\n\n-- Count distinct customers with orders\nSELECT COUNT(DISTINCT c.customer_id) AS customers_with_orders\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id;\n\n-- Sort joined orders by amount\nSELECT c.customer_name, o.order_id, o.order_amount\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nORDER BY o.order_amount DESC;\n\n-- Self join employees within the same department\nSELECT e1.first_name AS employee, e2.first_name AS colleague\nFROM employees e1 JOIN employees e2 ON e1.department = e2.department\nWHERE e1.employee_id <> e2.employee_id;\n\n-- Show employee and manager departments\nSELECT e.first_name AS employee, m.first_name AS manager, m.department\nFROM employees e LEFT JOIN employees m ON e.manager_id = m.employee_id;\n\n-- Keep joined rows with known customer IDs\nSELECT c.customer_name, o.order_id\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nWHERE o.customer_id IS NOT NULL;\n\n-- Customers with at least 3 orders\nSELECT c.customer_name, COUNT(o.order_id) AS order_count\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.customer_name\nHAVING COUNT(o.order_id) >= 3;\n\n-- Highest order amount for each customer\nSELECT c.customer_name, MAX(o.order_amount) AS highest_order\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.customer_name;\n\n-- Lowest order amount for each customer\nSELECT c.customer_name, MIN(o.order_amount) AS lowest_order\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.customer_name;\n\n-- Recent orders with customer names\nSELECT c.customer_name, o.order_id, o.order_date\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nORDER BY o.order_date DESC;\n\n-- Group joined data by city and customer\nSELECT c.city, c.customer_name, SUM(o.order_amount) AS total_spend\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.city, c.customer_name;\n\n-- Customers whose average order is above 1000\nSELECT c.customer_name, AVG(o.order_amount) AS average_order\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.customer_name\nHAVING AVG(o.order_amount) > 1000;\n\n-- Orders for customers outside Nagpur\nSELECT c.customer_name, c.city, o.order_id\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nWHERE c.city <> 'Nagpur';\n\n-- Employees who report to a manager\nSELECT e.first_name AS employee, m.first_name AS manager\nFROM employees e JOIN employees m ON e.manager_id = m.employee_id\nWHERE e.manager_id IS NOT NULL;\n\n-- Practice: top 3 customers by number of orders\nSELECT c.customer_name, COUNT(o.order_id) AS order_count\nFROM customers c JOIN orders o ON c.customer_id = o.customer_id\nGROUP BY c.customer_name\nORDER BY order_count DESC\nLIMIT 3;\n
-- Final Day 3 JOIN practice: customer count and total spend together
SELECT c.customer_name,
